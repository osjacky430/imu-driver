...
TEST(ImuInterfaceDestruction, destruction_should_null_object_and_always_return_OK) {
	...
	auto status = imuInterfaceDestroy(&spi_interface);

	EXPECT_TRUE(spi_interface == NULL);
